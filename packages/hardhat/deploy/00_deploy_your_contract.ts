...
/**
 * Deploys a contract named "Delegate" using the deployer account and
...
const deployDelegate: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  // const delegate = await hre.ethers.getContract("Delegate", deployer);
};

export default deployDelegate;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags Delegate
